    ...
    public partial class SeedingData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("42f5e3f0-97fe-4a0d-bc26-e9740088dd71"), "Hard" },
                    { new Guid("c5bd7091-75f1-4b7d-bd89-706e3da719dc"), "Medium" },
                    { new Guid("ca80bcbe-8e9f-483e-b2b2-3dffc38dc2ba"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("42f5e3f0-97fe-4a0d-bc26-e9740088dd71"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("c5bd7091-75f1-4b7d-bd89-706e3da719dc"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("ca80bcbe-8e9f-483e-b2b2-3dffc38dc2ba"));
